    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < size; j++) {
                canPlaced[i * size + j] = Integer.parseInt(st.nextToken()) == 1;
            }
        }
...
//            print(output);
        ...
        for (int i = 0; i < size * size; i++) {
            ...
            output[i] = isUsedLT[lt] = isUsedLB[lb] = true;
            func(idx + 1);
    ...
    private static void print(boolean[] output) {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                System.out.printf("%2s", output[i * size + j] ? "O" : "X");
            }
            System.out.println();
        }
        System.out.println();
